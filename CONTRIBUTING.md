Contributing to SlicerCAT
===============================

There are many ways to contribute to SlicerCAT.

  * Submit a feature request or bug, or add to the discussion on the [SlicerCAT issue tracker][is]
  * Submit a [Pull Request][pr] to improve SlicerCAT.
...
If you are new to SlicerCAT development and you don't have push access to the SlicerCAT
...
When submitting a PR, make sure to add a `Cc: @SlicerCAT/developers` comment to
notify SlicerCAT developers of your awesome contributions. Based on the
...
* You do NOT have push access: A SlicerCAT core developer will integrate your PR.
...
[pr]: https://github.com/aotal/SlicerCAT/merge_requests
[is]: https://github.com/aotal/SlicerCAT/issues
