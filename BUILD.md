Build and Package SlicerCAT
==============================

This document summarizes how to build and package SlicerCAT on Windows.

SlicerCAT is a custom Slicer application. Reading the [3D Slicer Developer Documentation](https://slicer.readthedocs.io/en/latest/developer_guide/index.html) may help answer additional questions.
...
* Setting up your git account:
    ...
    * If not already done, email `FirstName LastName <firstname.lastname@aotal.com>` to be granted access to
    the [aotal/SlicerCAT](https://github.com/aotal/SlicerCAT) repository.
...
mkdir W
cd /c/W
git clone https://github.com/aotal/SlicerCAT.git S
```
...
3. Open `C:\W\SR\SlicerCAT.sln`, select `Release` and build the project.
